...
public class Teste{
	public static void main(String[] args) throws ParseException {
		...
		Monitor m = new Monitor("20141004003", "123.145.789-98", convertStringToSqlString("10/02/1900"), "Thayanne Luiza Victor Landim de Sousa", "52618241", "Feminino", "1.233.789", "Thayannevls@gmail.com", "Informática", "2", ss,"Sala1", ba, s);
